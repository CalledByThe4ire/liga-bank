...
module.exports = function (asset, dir, options, decl) {
  ...
  if (isFont) {
    if ((!this.isDev || this.isDev && isModule) && this.store.fonts.indexOf(asset.absolutePath) === -1) this.store.fonts.push(asset.absolutePath);
    ...
    if ((!this.isDev || this.isDev && isModule) && this.store.imgs.indexOf(asset.absolutePath) === -1) this.store.imgs.push(asset.absolutePath);
